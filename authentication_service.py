...
def create_user():
    ...
    if is_validated is False:
        return jsonify(
            {'error': 'Invalid Password: Minimum of 8 characters, consisting only of letters and numbers'}), 400
...
def update_password():
    ...
    if is_validated is False:
        return jsonify(
            {'error': 'Invalid New Password: Minimum of 8 characters, consisting only of letters and numbers'}), 400
